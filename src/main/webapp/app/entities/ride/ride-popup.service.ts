        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.rideService.find(id).subscribe((ride) => {
                    ride.startDateTime = this.datePipe
                        .transform(ride.startDateTime, 'yyyy-MM-ddThh:mm');
                    ride.createdDateTime = this.datePipe
                        .transform(ride.createdDateTime, 'yyyy-MM-ddThh:mm');
